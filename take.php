...
<div class="container">
    ...
    ?>
            ...
            <form  method="GET">
                <div class="button">
                <button name="cancel" type="submit" class="btn1"> <a href="cancel_status_update.php?takeid=<?php echo $id; ?>">Cancel</a></button>
                <button name="approved" type="submit" class="btn2"><a href="approved_status_update.php?takeid=<?php echo $id; ?>">approved</a></button>
                </div>
            </form>
