...
<div class="container">
    ...
    <div class="thead">
        ...
        $select="select * from book_request where status='cancel'";
        ...
        while($row=mysqli_fetch_array($qry))
        {
           ...
           <div class="contain">
                ...
                <form action="add-services.php" method="GET"><a  href="cancelfinal.php?takeid=<?php echo $id;?>"><div class="action-btn">View</div></a></form>
